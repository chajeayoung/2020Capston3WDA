    ...
    render() {
        return (
            <div id="riroindex">
                ...
                <a className="btn btn-warning center" href='/userInfo/myAudition'>더보기</a>

                <hr></hr>
                <h2>나의 참여 투표</h2>
                <VoteTable id="vote"></VoteTable> 
                <a className="btn btn-warning center" href='/userInfo/voter'>더보기</a>

                <hr></hr>
                <h2>커뮤니티 목록</h2>
                <CommunityItem ></CommunityItem>    
                <a className="btn btn-warning center" href='/community'>더보기</a>
